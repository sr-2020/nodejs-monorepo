...
export class CopyAnotherCard extends React.Component<{ sendEvent: SendEvent }, { qrCodeId: string }> {
  state = { qrCodeId: '1' };
      ...
      <Card body={false}>
        ...
        <Card.Body>
          <InputGroup>
            ...
            <FormControl type="number" value={this.state.qrCodeId} onChange={(e) => this.setState({ qrCodeId: e.target.value })} />
            <InputGroup.Append>
