...
export const kAllSoftware: Software[] = [
  ...
  },
  {
    id: 'soft-medusa',
    name: 'медуза',
    description: 'Очень неприятная штука. Комбинация урона, многократного срабатывания, линк-лока и аларма. Отличный подарок\n\nТип: мина Dmg: 25 Mem: 10 Заряды: 3',
    ram: 10,
    kind: 'mine',
    charges: 3
  },
  ...
  },
  {
    id: 'soft-hunting',
    name: 'охота',
    description: 'Знаменитая мина русских военных хакеров. Неприятна тем, что наносит заметный урон не только на своей ноде, но и на соседних. Удачи с разведкой. Недостаток - ровно один. Очень тяжелая.\n\nТип: мина Dmg: 20 Mem: 20 Заряды: 1',
    ram: 20,
    kind: 'mine',
    charges: 1
  },
  ...
  },
  {
    id: 'soft-kalash',
    name: 'калаш',
    description: 'Безотказный и убийственный военный боевой эксплойт. Унылого шахтера с таким не встретишь\n\nТип: эксплойт Дмг: 5 Mem: 15 Заряды: 10',
    ram: 15,
    kind: 'weapon',
    charges: 10
  },
  ...
  },
  {
    id: 'soft-logger',
    name: 'логгер',
    description: 'Если установить такой софт на ноду с log-api хоста, позволяет поднять уровень логов до TRACE и получить дополнительную инфу о том, что было на хосте\n\nТип: агент Mem: 4',
    ram: 4,
    kind: 'deployment',
    charges: 1
  },
  ...
  },
  {
    id: 'soft-hearth',
    name: 'очаг',
    description: 'Приятно вечером собраться у очага с друзьями... тьфу. Восстанавливает, короче, всех на ноде через какое-то время\n\nТип: агент Mem: 12',
    ram: 12,
    kind: 'deployment',
    charges: 3
  },
