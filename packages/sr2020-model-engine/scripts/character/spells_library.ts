...
const kAllSpellsList: Spell[] = [
  ...
  // у мага на время T появляется пассивная способность fireball-able. T и amount зависят от Мощи. Снаряд выглядит как мягкий шар, его попадание обрабатывается согласно правилам по боевке (тяжелое магическое оружие). N=Мощь-3 (но не меньше 1), amount=Мощь*8 минут
  {
    ...
    description:
      'У мага на Мощь*4 минуты появляется пассивная способность Fireball, позволяющая кидать файерболы. Файербол должен выглядеть как обшитый мягким теннисный шар, и его попадание обрабатывается согласно правилам по боевке (тяжелое магическое оружие). Количество доступных файерболов: Мощь/2 (но не меньше 1),',
    prerequisites: ['arch-mage'],
    availability: 'open',
    karmaCost: 80,
    sphere: 'fighting',
  ...
  // у мага на время T1=Мощь*10 минут появляется активируемая способность Take no harm.
  {
    ...
    description:
      'На Мощь*10 минут выдаёт магу способность "раскрыть магический щит" (прозрачный зонтик, в течение 5 минут защищает от любого легкого оружия), потребуется её активация перед использованием.',
    prerequisites: ['arch-mage'],
    availability: 'open',
    karmaCost: 80,
    sphere: 'protection',
  ...
  // У мага появляется на 3 минуты пассивная абилка avalance-able. amount=Мощь/2 (округленное вверх). Пояснение как должно работать - сопровождающий мага мастер всем рассказывает, что у них хиты упали. Для подтверждения может показать текст.
  {
    ...
    description:
      'Снять со всех персонажей в реале в радиусе 5 метров (либо в пределах помещения) хиты (Мощь/2) Можно указать исключения, на кого заклинание не действует.',
    prerequisites: ['arch-mage'],
    availability: 'open',
    karmaCost: 100,
    sphere: 'fighting',
