...
const kAllSpellsList: Spell[] = [
  ...
  // У цели заклинания на T1=Мощь*20 минут появляется активируемая способность Pencil, Large!
  {
    ...
    description:
      'На Мощь*20 минут выдаёт другому существу способность "Pencil, large!" (одно холодное оружие в руках 1 минуту будет считаться тяжёлым), потребуется её активация перед использованием.',
    prerequisites: ['arch-mage'],
    availability: 'open',
    karmaCost: 80,
    sphere: 'fighting',
  ...
  // У цели заклинания на T1=Мощь*20 минут появляется активируемая способность Skin, Stone!
  {
    ...
    description:
      'На Мощь*20 минут выдаёт другому существу способность "Skin, Stone!" (надетая согласно остальным правилам лёгкая броня 1 минуту считается тяжёлой). Потребуется её активация',
    prerequisites: ['arch-mage'],
    availability: 'open',
    karmaCost: 50,
    sphere: 'protection',
  ...
  // На Мощь*2 минут магу выдаётся абилка Paralizard-effect
  {
    ...
    description:
      'В течение Мощь*2 минуты маг способен касанием и криком "Паралич!" обездвижить одно любое мясное тело на 90 секунд - игнорируя любую броню.',
    prerequisites: ['arch-mage'],
    availability: 'open',
    karmaCost: 70,
    sphere: 'fighting',
