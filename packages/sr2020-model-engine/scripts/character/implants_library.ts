...
export const kAllImplants: Implant[] = [
  ...
  },
  {
    ...
    slot: 'arm',
    description:
      'При наличии одного такого импланта и нужного навыка ты можешь использовать любое легкое холодное одноручное оружие, а также винтовки и автоматы. \nПри наличии двух имплантов и нужного навыка можешь использовать любое тяжелое холодное двуручное оружие, а так же пулемёты.',
    grade: 'alpha',
    essenceCost: 1.8,
    installDifficulty: 7,
    modifiers: [],
  ...
  },
  {
    ...
    slot: 'body',
    description:
      'Официальное название этого импланта "Биофидбек-фильтр", но так его называют разве что вейдж-слейвы на митингах в коворкингах. Его придумали много лет назад, чтобы повысить безопасность при проводном подключении через дата-линк к хот-симу Матрицы, ценой значительной потери остроты ощущений. \nВ настоящий момент его снова облюбовали декеры, а остальным он интересен очень слабо.\n\nУменьшает вероятность травмы от биофидбека',
    grade: 'alpha',
    essenceCost: 2.2,
    installDifficulty: 7,
  ...
  },
  {
    ...
    slot: 'body',
    description:
      'Официальное название этого импланта "Биофидбек-фильтр", но так его называют разве что вейдж-слейвы на митингах в коворкингах. Его придумали много лет назад, чтобы повысить безопасность при проводном подключении через дата-линк к хот-симу Матрицы, ценой значительной потери остроты ощущений. \nВ настоящий момент его снова облюбовали декеры, а остальным он интересен очень слабо.\n\nУменьшает вероятность травмы от биофидбека',    grade: 'beta',
    essenceCost: 1.5,
    installDifficulty: 9,
    modifiers: [modifierFromEffect(increaseBiofeedbackResistance, { amount: 10 })],
  },
  ...
  },
  {
    ...
    slot: 'body',
    description:
      'Выводит из состояния "тяжран" хозяина импланта через 10 минут после получения статуса, если имплант не был снят раньше другими способами. CD импланта 4 часа. ',
    grade: 'alpha',
    essenceCost: 2.2,
    installDifficulty: 7,
  ...
  },
  {
    ...
    name: 'RCC',
    slot: 'rcc',
    description: 'Позволяет подключаться к дронам. EoS 18',
    grade: 'delta',
    essenceCost: 0.4,
    installDifficulty: 15,
  ...
  },
  {
    ...
    name: 'Поддубный',
    slot: 'body',
    description: 'Добавляет +1 к параметру Тело',
    grade: 'alpha',
    essenceCost: 1.8,
    installDifficulty: 7,
  ...
  },
  {
    ...
    name: 'Нейропроцессор',
    slot: 'head',
    description: 'Добавляет +1 к параметру Интеллект',
    grade: 'alpha',
    essenceCost: 1.8,
    installDifficulty: 7,
  ...
  },
  {
    ...
    name: 'Dreamcast',
    slot: 'head',
    description: 'Максимальное время в VR +30 минут',
    grade: 'alpha',
    essenceCost: 1.8,
    installDifficulty: 7,
  ...
  },
  {
    ...
    name: 'Автопилот',
    slot: 'body',
    description: 'Максимальное время в дроне +15 минут',
    grade: 'alpha',
    essenceCost: 1.8,
    installDifficulty: 7,
  ...
  },
  {
    ...
    name: 'Стайер',
    slot: 'body',
    description: 'Даёт +5 минут к времени нахождения на хосте',
    grade: 'alpha',
    essenceCost: 1.8,
    installDifficulty: 7,
    modifiers: [modifierFromEffect(increaseMaxTimeAtHost, { amount: 5 })],
  },
  {
    id: 'stayer-beta',
    name: 'Стайер',
