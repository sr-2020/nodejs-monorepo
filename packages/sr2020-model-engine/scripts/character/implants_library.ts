...
export const kAllImplants: Implant[] = [
  {
    ...
    slot: 'body',
    description: 'Имплант +2 хита, иммунитет к Легкому холодному и легкому дистанционному оружию. Можешь надевать тяжёлую броню',
    grade: 'alpha',
    essenceCost: 3,
    installDifficulty: 7,
  ...
  },
  {
    ...
    name: 'крепкая спина',
    slot: 'body',
    description: 'Имплант +2 хита, снижение урона от тяжелого оружия.',
    grade: 'alpha',
    essenceCost: 3,
    installDifficulty: 7,
    modifiers: [modifierFromEffect(increaseMaxMeatHp, { amount: 2 })],
