...
export const kAllKarmaDiscounts: KarmaDiscount[] = [
  { archetype: 'arch-decker', metarace: 'meta-norm', discount: 10 },
  { archetype: 'arch-technomancer', metarace: 'meta-norm', discount: 5 },
  ...
  { archetype: 'arch-decker', metarace: 'meta-dwarf', discount: 5 },
  { archetype: 'arch-decker', metarace: 'meta-elf', discount: 5 },
  { archetype: 'arch-mage', metarace: 'meta-elf', discount: 5 },
  { archetype: 'arch-face', metarace: 'meta-elf', discount: 10 },
  { archetype: 'arch-technomancer', metarace: 'meta-ork', discount: 10 },
  ...
  { archetype: 'arch-technomancer', metarace: 'meta-troll', discount: 5 },
