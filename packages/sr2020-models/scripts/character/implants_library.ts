...
export const kAllImplants: Implant[] = [
  ...
  },
  {
    ...
    name: 'RCC',
    slot: 'rcc',
    description: 'позволяет подключаться к дронам Сенсор 4',
    grade: 'alpha',
    essenceCost: 1.5,
    installDifficulty: 3,
  ...
  },
  {
    ...
    name: 'RCC',
    slot: 'rcc',
    description: 'позволяет подключаться к дронам Сенсор 8',
    grade: 'beta',
    essenceCost: 1.2,
    installDifficulty: 4,
  ...
  },
  {
    ...
    name: 'RCC',
    slot: 'rcc',
    description: 'позволяет подключаться к дронам Сенсор 12',
    grade: 'gamma',
    essenceCost: 0.9,
    installDifficulty: 5,
  ...
  },
  {
    ...
    name: 'RCC',
    slot: 'rcc',
    description: 'позволяет подключаться к дронам Сенсор 16',
    grade: 'delta',
    essenceCost: 0.6,
    installDifficulty: 6,
