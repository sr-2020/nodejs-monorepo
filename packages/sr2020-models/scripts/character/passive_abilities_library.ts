...
const kAllPassiveAbilitiesList: PassiveAbility[] = [
...

  {
    ...
    // 446
    // Разблокирует возможность сканить qr-коды персонажей для эффекта "ритуал": N разных сосканированных за время действия заклинания qr-кодов мясных тел увеличивают магу Мощь на √N на ближайшее заклинание.
    modifier: [],
  },

  {
    ...
    // 447
    // Разблокирует возможность сканить qr-коды персонажей для эффекта "ритуал": N уникальных сосканированных за время действия заклинания qr-кодов мясных тел увеличивают магу Мощь и Сопротивление Откату на √N на ближайшее заклинание.
    modifier: [],
  },
