...
const kAllPassiveAbilitiesList: PassiveAbility[] = [
...

  {
    ...
    description: 'Сосканированные qr-коды пропорционально увеличивают Мощь на ближайшее заклинание',
    // 416
    // Разблокирует возможность сканить qr-коды мясных тел в состоянии здоров/тяжран (не годятся КС/АС) для эффекта "ритуал": N разных сосканированных за время действия заклинания qr-кодов увеличивают магу Мощь на √N на ближайшее заклинание.
    modifier: [],
  },

  {
    ...
    description: 'Сосканированные qr-коды пропорционально увеличивают Мощь и Сопротивление Откату на ближайшее заклинание',
    // 417
    // Разблокирует возможность сканить qr-коды мясных тел в состоянии здоров/тяжран (не годятся КС/АС) для эффекта "православный ритуал": N уникальных сосканированных за время действия заклинания qr-кодов увеличивают магу Мощь, А ТАКЖЕ Сопротивление Откату на √N на ближайшее заклинание.
    modifier: [],
  },
