...
const kAllPassiveAbilitiesList: PassiveAbility[] = [
...

  {
    ...
    // 446
    // Время действия 5 минут, кулдаун 20 минут, N разных сосканированных за время действия заклинания qr-кодов мясных тел увеличивают магу Мощь на √N на ближайшее заклинание.
    modifier: [],
  },

  {
    ...
    // 447
    // Время действия 5 минут, кулдаун 10 минут, N уникальных сосканированных за время действия заклинания qr-кодов мясных тел увеличивают магу Мощь и Сопротивление Откату на √N на ближайшее заклинание.
    modifier: [],
  },
