          ...
          items: [
            {
              ...
              details: {
                ...
                text:
                  '<p>Какие-то воспоминания о хрен знает чем...</p><p><a href="http://link-to-local-server.local/url">http://link-to-local-server.local/url</a></p>',
              },
            },
            {
              ...
              details: {
                header: 'Воспоминание',
                text:
                  '<p>Название воспоминания №2.</p><p><a href="http://link-to-local-server.local/url2">http://link-to-local-server.local/url2</a></p>',
              },
            },
          ],
        },
