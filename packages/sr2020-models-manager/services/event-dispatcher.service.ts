...
import { EventDispatcherService, GenerocEventDispatcherService } from '@alice/alice-models-manager/services/event-dispatcher.service';
...
export class EventDispatcherServiceProvider implements Provider<EventDispatcherService> {
  ...
  value(): EventDispatcherService {
    return new GenerocEventDispatcherService(this._modelEngineService, [Sr2020Character, Location, QrCode]);
  }
}
